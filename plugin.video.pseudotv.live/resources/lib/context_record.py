...
if __name__ == '__main__': 
    ...
    if   param == 'add': timerit(Record(sys.argv,sys.listitem,decodePlot(BUILTIN.getInfoLabel('Plot'))).add)(0.1)
    elif param == 'del': timerit(Record(sys.argv,sys.listitem,decodePlot(BUILTIN.getInfoLabel('Plot'))).remove)(0.1)
